...
![ecommerce-homepage](https://github.com/Anmol1085/E-commerce/edit/main/readme.md)<!-- ![ecommerce-banner](https://github.com/RishiBakshii/mern-ecommerce/blob/main/frontend/src/assets/images/banner4.jpg?raw=true) -->
![ecommerce-banner]()
...
```bash
  git clone[ (https://github.com/Anmol1085/E-commerce.git) ]
```
